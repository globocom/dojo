#coding: utf-8
import unittest
from poker import play_poker, check_pairs, get_highest_card, Card, score
...
class PokerTestCase(unittest.TestCase):
	...
	def test_highest_card_ties(self):
		person1 = [u"4♣", u"2♥", u"A♦", u"10♠", u"5♠"]
		person2 = [u"3♣", u"A♥", u"6♦", u"4♠", u"2♠"]
		computed = play_poker(person1, person2)
		expected = "Tie"
		self.assertEqual(computed, expected)
	...
	def test_one_pair_each_person(self):
		person1 = [u"4♣", u"2♥", u"2♦", u"10♠", u"5♠"]
		person2 = [u"9♣", u"3♥", u"3♦", u"4♠", u"2♠"]
		computed = play_poker(person1, person2)
		expected = "Person 2 won"
		self.assertEqual(computed, expected)
